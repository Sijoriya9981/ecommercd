    ...
    return (
        <>
            ...
            >
                ...
                {
                    context.isopenfullscreenpanel?.modal === 'Add Sub Category' &&
                    <>
                        <AddSubCategory />
                    </>
                }
            ...
            <div className="flex items-center justify-end px-2  pr-0 py-0 mt-2">
                <h2 className='text-[20px] font-[600] '>Sub Category </h2>
                <div className="col w-fit  ml-auto flex items-center gap-3">
                    ...
                    }}><IoAddOutline className='text-[20px]' />Add Sub Category</Button>
                </div>
            </div>
                        ...
                        <Table stickyHeader aria-label="sticky table">
                            ...
                            <TableBody>
                                ...
                                <TableRow>
                                    ...
                                    <TableCell width={100}>                         <Chip label="Electronic" />    </TableCell>
                                    <TableCell width={100}>
                                        <div className="flex items-center gap-2">
                                            <Chip label="Men" color='primary' onDelete={() => { }} />
                                            <Chip label="Women" color='primary' onDelete={() => { }} />
                                            <Chip label="Kids" color='primary' onDelete={() => { }} />
