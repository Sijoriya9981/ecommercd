    ...
    return (
        <>
            ...
            <section className="bg-[#fff] w-full">
                ...
                <div className="card loginBox w-[500px] !h-[auto] mx-auto pt-10 pb-10 relative z-50 overflow-x-auto">
                    ...
                    <form action="" className="w-full px-8 mt-3">
                        ...
                        <div className="form-group mb-4 w-full flex items-center justify-between">
                            ...
                            <Link to={'/forgotpassword'} className='text-primary font-[300] hover:underline hover:text-gray-600'>Forgot Password</Link>
                        </div>

                        <Button className='btn-blue w-full'>Login</Button>
                    </form>
                </div >
            </section >
        </>
